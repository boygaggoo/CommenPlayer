...
import com.d.commenplayer.widget.util.Factory;
import com.d.commenplayer.widget.util.FileMediaDataSource;
import com.d.commenplayer.widget.util.InfoHudViewHolder;
...
public class IjkVideoView extends FrameLayout implements MediaController.MediaPlayerControl {
    ...
    private void init(Context context) {
        ...
        initBackground();
        IRenderView renderView = Factory.initRenders(mAppContext, mMediaPlayer, mCurrentAspectRatio);
    ...
    private void openVideo() {
        ...
        try {
            mMediaPlayer = Factory.createPlayer(mAppContext, mSettings.getPlayer(), mUri);
            ...
            new IMediaPlayer.OnErrorListener() {
                public boolean onError(IMediaPlayer mp, int framework_err, int impl_err) {
                    ...
                    if (framework_err == MediaPlayer.MEDIA_ERROR_NOT_VALID_FOR_PROGRESSIVE_PLAYBACK) {
                        Log.d(TAG, "onError:" + "Invalid progressive playback");
                    } else {
                    ...
                    if (listener != null) {
                        if (listener.onError(mMediaPlayer, framework_err, impl_err)) {
                            return true;
                        }
                    }
